...
<footer class="l-fot">
  ...
  <div class="l-fot-wrp m-wrpc-s e-off">
    <div class="m-rom m-flc">
      <span class="m-body-s"><a href="https://github.com/crc-Studio/wampmono" target="_blank"><i>Wampmono™</i></a>, a light Manager for <a href="https://wampserver.aviatechno.net/" target="_blank">Wampserver</a></span>
